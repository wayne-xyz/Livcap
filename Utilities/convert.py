# Convert the pytorch model .pt file to .safetensor file for loading into mlx-swift
# CUrrent mlx-swift only support safetensors file
# Original script from https://github.com/mlx-ai/mlx-whisper/blob/main/convert.py

"""
This script converts Whisper model from PyTorch format (.pt) to safetensors format for use with MLX-Swift.

Usage Example:
To convert the tiny.en model to your local folder:

1. Make sure you have the required dependencies:
   pip install mlx mlx-whisper torch numpy tqdm

2. Run the conversion command:
   python Utilities/convert.py --torch-name-or-path "tiny.en" --mlx-path "WhisperModelTiny"

This will:
- Download the tiny.en model from OpenAI
- Convert it to safetensors format
- Save it in your WhisperModelTiny folder as 'weights.safetensors'
- Also save the config.json in the same folder

The output files will be:
- WhisperModelTiny/weights.safetensors
- WhisperModelTiny/config.json
"""
